...
public class AES {	
	...
	public String Encrypt(String PLAINTEXT, String KEY, int ROUND){
		...
		System.out.println("Rcon[1] =" + rcon[1]);
		for(int i=0;i<4;i++)
			for(int j=0;j<4;j++){
				State[i][j] = PlainBytes[(4*i)+j];
				KeyState[i][j] = KeyBytes[(4*i)+j];
			}
		System.out.println("Initial Plain State");
		PrintState(State);
		System.out.println("Initial Key   State");
		PrintState(KeyState);
		...
		String PlainHex = DatatypeConverter.printHexBinary(PlainBytes);
		System.out.printf("PlainHex: 0x%s\n", PlainHex);
		*/
	 ...
	 */
	public String Decrypt(String CIPHERTEXT, String KEY, int ROUND){
